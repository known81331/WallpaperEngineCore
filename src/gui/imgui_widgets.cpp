...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    if (!(held || hovered))
        ImGui::PushStyleColor(ImGuiCol_Text, GetColorU32(ImGuiCol_WindowBg));
...
bool ImGui::ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size, ImGuiButtonFlags flags)
{
    ...
    const ImU32 text_col = GetColorU32((held && hovered) ? ImGuiCol_Text : ImGuiCol_WindowBg );
    RenderNavCursor(bb, id);
...
bool ImGui::ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& image_size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col, ImGuiButtonFlags flags)
{
    ...
    window->DrawList->AddImage(texture_id, bb.Min + padding, bb.Max - padding, uv0, uv1, hovered ? GetColorU32(tint_col) : GetColorU32(bg_col) );
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    if (!(flags & ImGuiComboFlags_NoArrowButton))
    {
        ...
        ImU32 text_col = GetColorU32((popup_open || hovered) ? ImGuiCol_Text : ImGuiCol_WindowBg);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    if ((held && (hovered || (flags & ImGuiSelectableFlags_Highlight))))
        ImGui::PushStyleColor(ImGuiCol_Text, GetColorU32(ImGuiCol_WindowBg));
