...
#ifndef mtl_renderer_h
#define mtl_renderer_h
...
public:
    ...
    void renderCompositionShadowPipeline(MTL::CommandBuffer* pCmd);
    void renderSkydome(MTL::CommandBuffer* pCmd, CA::MetalDrawable* drawable);
    void renderTahoePipeline(MTL::CommandBuffer* pCmd, CA::MetalDrawable* drawable);
    void renderSequoiaPipeline(MTL::CommandBuffer* pCmd, CA::MetalDrawable* drawable);
    void renderGodraysPipeline(MTL::CommandBuffer* pCmd);
    void renderLightingPipeline(MTL::CommandBuffer* pCmd, CA::MetalDrawable* drawable);
    void endFrame();
